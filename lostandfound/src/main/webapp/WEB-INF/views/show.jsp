...
<body>
    <div class="container">
        ...
        <!-- Search Form -->
        <form method="GET" action="/user/items" class="form-inline mb-4">
                ...
                <div class="col-md-6 item-card">
                    <div class="card">
                        ...
                        <div class="card-body item-card-body">
                            ...
                            <a href="/user/change-claim-status?itemId=${item.id}" class="btn btn-primary">Change Claim Status</a>
                        </div>
                    </div>
                </div>
            </c:forEach>
